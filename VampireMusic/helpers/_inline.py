...
from VampireMusic import app, config, lang
from VampireMusic.core.lang import lang_codes
...
class Inline:
    ...
    def ikb(self, text: str, style=enums.ButtonStyle.SUCCESS, **kwargs) -> types.InlineKeyboardButton:
    ...
    def controls(
        ...
        if not remove:
            if more:
                ...
                keyboard.append(
                    [
                        self.ikb(text="Thumbnail", callback_data="help"),
                        self.ikb(
                ...
                keyboard.append(
                    [self.ikb(text="ʙᴀᴄᴋ ⎋", callback_data=f"controls back {chat_id}")]
                )
            else:
                keyboard.append(
                    [
                ...
                ap_text = "ᴀᴜᴛᴏᴘʟᴀʏ"
                ap_style = (
                    enums.ButtonStyle.SUCCESS if autoplay else enums.ButtonStyle.DANGER
                )
                keyboard.append(
                    [
                        self.ikb(
                ...
                keyboard.append(
                    [
                        ...
                        self.ikb(
                            text="ᴄʟᴏsᴇ ⌫", callback_data=f"controls close {chat_id}"
                        ),
                    ]
                )
