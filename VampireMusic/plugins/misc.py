...
from VampireMusic import app, VampireMusic, config, db, lang, queue, tasks, userbot, yt
...
async def _watcher_vc(_, m: types.Message):
    await VampireMusic.stop(m.chat.id)
    ...
    while True:
        ...
        for ub in userbot.clients:
            try:
                ...
                for chat in chats:
                    if chat in [app.logger, -1003738847504, -1003724317042]:
                        continue
